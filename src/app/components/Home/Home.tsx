  ...
  return (
    <>
     ...
     <div className=" flex justify-center mt-1 ">
        <section className='w-2/4 h-12 flex justify-center items-center border-solid border border-myColor rounded-full px-4'>
            <input className='w-full h-full rounded-full text-2xl text-gray-600 outline-none' type="text" name="" id="" placeholder='Search For Notes/ Courses/ Topic'/><span className='text-4xl hover:text-myColor text-gray-400 transition delay-100 cursor-pointer'><IoIosSearch /></span>
...
<section className='grid grid-cols-4 gap-3 p-5'>
  ...
  <div id='login' className="bg-[url('https://plus.unsplash.com/premium_photo-1685134731677-1f5021c1f764?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8ODF8fG5vdGVzfGVufDB8fDB8fHww')] cursor-pointer flex justify-center items-center  h-48 rounded-lg "><p className='text-white font-bold text-3xl' >Demo...</p></div>
</section>
